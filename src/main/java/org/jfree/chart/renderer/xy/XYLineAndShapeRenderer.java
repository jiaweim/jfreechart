...
/**
 * A renderer that connects data points with lines and/or draws shapes at each data point.  This renderer is designed
 * for use with the {@link XYPlot} class.  The example shown here is generated by the
 * {@code XYLineAndShapeRendererDemo2.java} program included in the JFreeChart demo collection:
 * <br><br>
        ...
        implements XYItemRenderer, Cloneable, PublicCloneable, Serializable
{
    ...
    /**
     * Returns a flag that controls whether or not each series is drawn as a single path.  The default value is
     * {@code false}.
     *
     * @return A boolean.
     ...
     * Returns the flag used to control whether or not the shape for an item is visible.
     * <p>
     * The default implementation passes control to the {@code getSeriesShapesVisible()} method. You can override this
    ...
    /**
     * Returns {@code true} if the renderer should use the fill paint setting to fill shapes, and {@code false} if it
     * should just use the regular paint.
     * <p>
     * Refer to {@code XYLineAndShapeRendererDemo2.java} to see the effect of this flag.
     *
     * @return A boolean.
    ...
    /**
     * Returns {@code true} if the renderer should use the outline paint setting to draw shape outlines, and
     ...
     * a {@code GeneralPath} is constructed and drawn at the end of the series painting.
     *
     * @param g2         the graphics device.
     * @param state      the renderer state.
     * @param plot       the plot (can be used to obtain standard color information etc).
    ...
    /**
     * Draws the item shapes and adds chart entities (second pass). This method draws the shapes which mark the item
     * positions. If {@code entities} is not {@code null} it will be populated with entity information for points that
     * fall within the data area.
     *
     * @param g2             the graphics device.
     * @param plot           the plot (can be used to obtain standard color information etc).
     * @param domainAxis     the domain axis.
