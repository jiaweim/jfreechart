...
public class XYItemRendererState extends RendererState
{
    ...
    /**
     * A flag that controls whether the plot should pass ALL data items to the renderer, or just the items that will be
     * visible.
     *
     * @since 1.0.6
     */
    ...
    /**
     * Returns the flag that controls whether the plot passes all data items in each series to the renderer, or just the
     * visible items.  The default value is {@code true}.
     *
     * @return A boolean.
    ...
    /**
     * Sets the flag that controls whether the plot passes all data items in each series to the renderer, or just the
     * visible items.
     *
    ...
    /**
     * This method is called by the {@link XYPlot} when it starts a pass through the (visible) items in a series.  The
     * default implementation records the first and last item indices - override this method to implement additional
    ...
    /**
     * This method is called by the {@link XYPlot} when it ends a pass through the (visible) items in a series.  The
     * default implementation does nothing, but you can override this method to implement specialised behaviour.
     *
     * @param dataset   the dataset.
     * @param series    the series index.
     * @param firstItem the index of the first item in the series.
