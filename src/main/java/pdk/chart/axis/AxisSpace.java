...
public class AxisSpace implements Cloneable, PublicCloneable, Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof AxisSpace that)) {
            return false;
        }
    ...
    public int hashCode() {
        int result = 23;
        result = 37 * result + Double.hashCode(this.top);
        result = 37 * result + Double.hashCode(this.bottom);
        result = 37 * result + Double.hashCode(this.left);
        result = 37 * result + Double.hashCode(this.right);
        return result;
    }
